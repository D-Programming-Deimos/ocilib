...
const OCI_IMPORT_MODE_LINKAGE =  1;
const OCI_IMPORT_MODE_RUNTIME =  2;
...
const OCI_CHAR_ANSI =       1;
const OCI_CHAR_WIDE =       2;
...
extern(C) char* ocistrdup
(
    const(char)* src
);
extern(C) int ocistrcasecmp
(
    const(char)* str1,
    const(char)* str2
);
...
// #ifdef OCI_INCLUDE_WCHAR
extern(C) wchar * ociwcsdup
(
    const(wchar)* src
);
extern(C) int ociwcscasecmp
(
    const(wchar)* str1,
    const(wchar)* str2
);
...
uint OCI_VER_MAJ()(uint v) { return cast(uint) (v/100); }
uint OCI_VER_MIN()(uint v) { return cast(uint) ((v/10) - ((v/100)*10)); }
uint OCI_VER_REV()(uint v) { return cast(uint) ((v) - ((v/10)*10)); }

/* OCILIB Error types */

const OCI_ERR_ORACLE =                      1;
const OCI_ERR_OCILIB =                      2;
const OCI_ERR_WARNING =                     3;

/* OCILIB Error codes */

const OCI_ERR_NONE =                        0;
const OCI_ERR_NOT_INITIALIZED =             1;
const OCI_ERR_LOADING_SHARED_LIB =          2;
const OCI_ERR_LOADING_SYMBOLS =             3;
const OCI_ERR_MULTITHREADED =               4;
const OCI_ERR_MEMORY =                      5;
const OCI_ERR_NOT_AVAILABLE =               6;
const OCI_ERR_NULL_POINTER =                7;
const OCI_ERR_DATATYPE_NOT_SUPPORTED =      8;
const OCI_ERR_PARSE_TOKEN =                 9;
const OCI_ERR_MAP_ARGUMENT =                10;
const OCI_ERR_OUT_OF_BOUNDS =               11;
const OCI_ERR_UNFREED_DATA =                12;
const OCI_ERR_MAX_BIND =                    13;
const OCI_ERR_ATTR_NOT_FOUND =              14;
const OCI_ERR_MIN_VALUE =                   15;
const OCI_ERR_NOT_COMPATIBLE =              16;
const OCI_ERR_STMT_STATE =                  17;
const OCI_ERR_STMT_NOT_SCROLLABLE =         18;
const OCI_ERR_BIND_ALREADY_USED =           19;
const OCI_ERR_BIND_ARRAY_SIZE =             20;
const OCI_ERR_COLUMN_NOT_FOUND =            21;
...
const OCI_BIND_BY_POS =                     0;
const OCI_BIND_BY_NAME =                    1;
const OCI_BIND_SIZE =                       6;
const OCI_BIND_MAX =                        1024;

/* fetching */

const OCI_FETCH_SIZE =                      20;
const OCI_PREFETCH_SIZE =                   20;
const OCI_LONG_EXPLICIT =                   1;
const OCI_LONG_IMPLICIT =                   2;
...
const OCI_CDT_NUMERIC =                     1;
const OCI_CDT_DATETIME =                    3;
const OCI_CDT_TEXT =                        4;
const OCI_CDT_LONG =                        5;
const OCI_CDT_CURSOR =                      6;
const OCI_CDT_LOB =                         7;
const OCI_CDT_FILE =                        8;
const OCI_CDT_TIMESTAMP =                   9;
const OCI_CDT_INTERVAL =                    10;
const OCI_CDT_RAW =                         11;
const OCI_CDT_OBJECT =                      12;
const OCI_CDT_COLLECTION =                  13;
const OCI_CDT_REF =                         14;

/* Data Type codes for OCI_ImmediateXXX() calls */

const OCI_ARG_SHORT =                       1;
const OCI_ARG_USHORT =                      2;
const OCI_ARG_INT =                         3;
const OCI_ARG_UINT =                        4;
const OCI_ARG_BIGINT =                      5;
const OCI_ARG_BIGUINT =                     6;
const OCI_ARG_DOUBLE =                      7;
const OCI_ARG_DATETIME =                    8;
const OCI_ARG_TEXT =                        9;
const OCI_ARG_LOB =                         10;
const OCI_ARG_FILE =                        11;
const OCI_ARG_TIMESTAMP =                   12;
const OCI_ARG_INTERVAL =                    13;
const OCI_ARG_RAW =                         14;
...
const OCI_CST_UPDATE =                      2;
const OCI_CST_DELETE =                      3;
const OCI_CST_INSERT =                      4;
const OCI_CST_CREATE =                      5;
const OCI_CST_DROP =                        6;
...
const OCI_ENV_DEFAULT =                     0;
const OCI_ENV_THREADED =                    1;
const OCI_ENV_CONTEXT =                     2;
const OCI_ENV_EVENTS =                      4;

/* sessions modes */

const OCI_SESSION_DEFAULT =                 0;
const OCI_SESSION_XA =                      1;
const OCI_SESSION_SYSDBA =                  2;
const OCI_SESSION_SYSOPER =                 4;
const OCI_SESSION_PRELIM_AUTH =             8;

/* change notification types */

const OCI_CNT_OBJECTS =                     1;
const OCI_CNT_ROWS =                        2;
const OCI_CNT_DATABASES =                   4;
const OCI_CNT_ALL =                         OCI_CNT_OBJECTS | OCI_CNT_ROWS | OCI_CNT_DATABASES;

/* event notification types */

const OCI_ENT_STARTUP =                     1;
const OCI_ENT_SHUTDOWN =                    2;
const OCI_ENT_SHUTDOWN_ANY =                3;
const OCI_ENT_DROP_DATABASE =               4;
const OCI_ENT_DEREGISTER =                  5;
const OCI_ENT_OBJECT_CHANGED =              6;

/* event object notification types */

const OCI_ONT_INSERT =                      0x2;
const OCI_ONT_UPDATE =                      0x4;
const OCI_ONT_DELETE =                      0x8;
const OCI_ONT_ALTER =                       0x10;
const OCI_ONT_DROP =                        0x20;
const OCI_ONT_GENERIC =                     0x40;

/* database startup modes */

const OCI_DB_SPM_START =                    1;
const OCI_DB_SPM_MOUNT =                    2;
const OCI_DB_SPM_OPEN =                     4;
const OCI_DB_SPM_FULL =                     OCI_DB_SPM_START | OCI_DB_SPM_MOUNT | OCI_DB_SPM_OPEN;

/* database startup flags */

const OCI_DB_SPF_DEFAULT =                  0;
const OCI_DB_SPF_FORCE =                    1;
const OCI_DB_SPF_RESTRICT =                 2;

/* database shutdown modes */

const OCI_DB_SDM_SHUTDOWN =                 1;
const OCI_DB_SDM_CLOSE =                    2;
const OCI_DB_SDM_DISMOUNT =                 4;
const OCI_DB_SDM_FULL =                     OCI_DB_SDM_SHUTDOWN | OCI_DB_SDM_CLOSE | OCI_DB_SDM_DISMOUNT;

/* database shutdown flags */

const OCI_DB_SDF_DEFAULT =                  0;
const OCI_DB_SDF_TRANS =                    1;
const OCI_DB_SDF_TRANS_LOCAL =              2;
const OCI_DB_SDF_IMMEDIATE =                3;
const OCI_DB_SDF_ABORT =                    4;

/* charset form types */

const OCI_CSF_NONE =                        0;
const OCI_CSF_DEFAULT =                     1;
const OCI_CSF_NATIONAL =                    2;

/* statement fetch mode */

const OCI_SFM_DEFAULT =                     0;
const OCI_SFM_SCROLLABLE =                  0x08;

/* statement fetch direction */

const OCI_SFD_ABSOLUTE =                    0x20;
const OCI_SFD_RELATIVE =                    0x40;

/* bind allocation mode */

const OCI_BAM_EXTERNAL =                    1;
const OCI_BAM_INTERNAL =                    2;

/* bind direction mode */

const OCI_BDM_IN =                          1;
const OCI_BDM_OUT =                         2;
const OCI_BDM_IN_OUT =                      (OCI_BDM_IN | OCI_BDM_OUT);

/* Integer sign flag */

const OCI_NUM_UNSIGNED =                    2;
...
const OCI_NUM_UINT =                        (OCI_NUM_INT    | OCI_NUM_UNSIGNED);
const OCI_NUM_BIGUINT =                     (OCI_NUM_BIGINT | OCI_NUM_UNSIGNED);

/* timestamp types */

const OCI_TIMESTAMP =                       1;
const OCI_TIMESTAMP_TZ =                    2;
const OCI_TIMESTAMP_LTZ =                   3;

/* interval types */

const OCI_INTERVAL_YM =                     1;
const OCI_INTERVAL_DS =                     2;
...
const OCI_SEEK_SET =                        1;
const OCI_SEEK_END =                        2;
const OCI_SEEK_CUR =                        3;

/* type info types */

const OCI_TIF_TABLE =                       1;
const OCI_TIF_VIEW =                        2;
const OCI_TIF_TYPE =                        3;

/* object type */

const OCI_OBJ_PERSISTENT =                  1;
const OCI_OBJ_TRANSIENT =                   2;
const OCI_OBJ_VALUE =                       3;

/* collection types */

const OCI_COLL_VARRAY =                     1;
const OCI_COLL_NESTED_TABLE =               2;

/* pool types */

const OCI_POOL_CONNECTION =                 1;
const OCI_POOL_SESSION =                    2;
...
const OCI_ASD_BEFORE =                      2;
const OCI_ASD_TOP =                         3;

/* AQ message visibility    */

const OCI_AMV_IMMEDIATE =                   1;
const OCI_AMV_ON_COMMIT =                   2;

/* AQ dequeue mode    */

const OCI_ADM_BROWSE =                      1;
const OCI_ADM_LOCKED =                      2;
const OCI_ADM_REMOVE =                      3;
const OCI_ADM_REMOVE_NODATA =               4;

/* AQ dequeue navigation */

const OCI_ADN_FIRST_MSG =                   1;
const OCI_ADN_NEXT_TRANSACTION =            2;
const OCI_ADN_NEXT_MSG =                    3;

/* AQ queue table purge mode */

const OCI_APM_BUFFERED =                    1;
const OCI_APM_PERSISTENT =                  2;
const OCI_APM_ALL =                         (OCI_APM_BUFFERED | OCI_APM_PERSISTENT);
/* AQ queue table grouping mode */

const OCI_AGM_NONE =                        0;
const OCI_AGM_TRANSACTIONNAL =              1;

/* AQ queue table type */

const OCI_AQT_NORMAL =                      0;
const OCI_AQT_EXCEPTION =                   1;
const OCI_AQT_NON_PERSISTENT =              2;

/* direct path processing return status */

const OCI_DPR_COMPLETE =                    1;
const OCI_DPR_ERROR =                       2;
...
const OCI_SIZE_TRACE_ID =                   64;
const OCI_SIZE_TRACE_MODULE =               48;
const OCI_SIZE_TRACE_ACTION =               32;
const OCI_SIZE_TRACE_INF0 =                 64;

/* trace types */

const OCI_TRC_IDENTITY =                    1;
const OCI_TRC_MODULE =                      2;
const OCI_TRC_ACTION =                      3;
const OCI_TRC_DETAIL =                      4;

/* HA event type */

const OCI_HET_DOWN =                        0;
const OCI_HET_UP =                          1;

/* HA event source */
const OCI_HES_INSTANCE =                    0;
const OCI_HES_DATABASE =                    1;
const OCI_HES_NODE =                        2;
const OCI_HES_SERVICE =                     3;
const OCI_HES_SERVICE_MEMBER =              4;
const OCI_HES_ASM_INSTANCE =                5;
const OCI_HES_PRECONNECT =                  6;

/* Fail over types */

const OCI_FOT_NONE =                        1;
const OCI_FOT_SESSION =                     2;
const OCI_FOT_SELECT =                      4;

/* fail over notifications */

const OCI_FOE_END =                         1;
const OCI_FOE_ABORT =                       2;
const OCI_FOE_REAUTH =                      4;
const OCI_FOE_BEGIN =                       8;
const OCI_FOE_ERROR =                       16;

/* fail over callback return code */

const OCI_FOC_OK =                          0;
const OCI_FOC_RETRY =                       25410;

/* hash tables support */

const OCI_HASH_STRING =                     1;
const OCI_HASH_INTEGER =                    2;
const OCI_HASH_POINTER =                    3;

/* transaction types */

const OCI_TRS_NEW =                         0x00000001;
const OCI_TRS_READONLY =                    0x00000100;
const OCI_TRS_READWRITE =                   0x00000200;
const OCI_TRS_SERIALIZABLE =                0x00000400;
const OCI_TRS_LOOSE =                       0x00010000;
const OCI_TRS_TIGHT =                       0x00020000;

/* sql function codes */

const OCI_SFC_CREATE_TABLE =                1;
const OCI_SFC_SET_ROLE =                    2;
const OCI_SFC_INSERT =                      3;
const OCI_SFC_SELECT =                      4;
const OCI_SFC_UPDATE =                      5;
const OCI_SFC_DROP_ROLE =                   6;
const OCI_SFC_DROP_VIEW =                   7;
const OCI_SFC_DROP_TABLE =                  8;
const OCI_SFC_DELETE =                      9;
const OCI_SFC_CREATE_VIEW =                 10;
const OCI_SFC_DROP_USER =                   11;
const OCI_SFC_CREATE_ROLE =                 12;
const OCI_SFC_CREATE_SEQUENCE =             13;
const OCI_SFC_ALTER_SEQUENCE =              14;

const OCI_SFC_DROP_SEQUENCE =               16;
const OCI_SFC_CREATE_SCHEMA =               17;
const OCI_SFC_CREATE_CLUSTER =              18;
const OCI_SFC_CREATE_USER =                 19;
const OCI_SFC_CREATE_INDEX =                20;
const OCI_SFC_DROP_INDEX =                  21;
const OCI_SFC_DROP_CLUSTER =                22;
const OCI_SFC_VALIDATE_INDEX =              23;
const OCI_SFC_CREATE_PROCEDURE =            24;
const OCI_SFC_ALTER_PROCEDURE =             25;
const OCI_SFC_ALTER_TABLE =                 26;
const OCI_SFC_EXPLAIN =                     27;
const OCI_SFC_GRANT =                       28;
const OCI_SFC_REVOKE =                      29;
const OCI_SFC_CREATE_SYNONYM =              30;
const OCI_SFC_DROP_SYNONYM =                31;
const OCI_SFC_ALTER_SYSTEM_SWITCHLOG =      32;
const OCI_SFC_SET_TRANSACTION =             33;
const OCI_SFC_PLSQL_EXECUTE =               34;
const OCI_SFC_LOCK =                        35;
const OCI_SFC_NOOP =                        36;
const OCI_SFC_RENAME =                      37;
const OCI_SFC_COMMENT =                     38;
const OCI_SFC_AUDIT =                       39;
const OCI_SFC_NO_AUDIT =                    40;
const OCI_SFC_ALTER_INDEX =                 41;
const OCI_SFC_CREATE_EXTERNAL_DATABASE =    42;
const OCI_SFC_DROP_EXTERNALDATABASE =       43;
const OCI_SFC_CREATE_DATABASE =             44;
const OCI_SFC_ALTER_DATABASE =              45;
const OCI_SFC_CREATE_ROLLBACK_SEGMENT =     46;
const OCI_SFC_ALTER_ROLLBACK_SEGMENT =      47;
const OCI_SFC_DROP_ROLLBACK_SEGMENT =       48;
const OCI_SFC_CREATE_TABLESPACE =           49;
const OCI_SFC_ALTER_TABLESPACE =            50;
const OCI_SFC_DROP_TABLESPACE =             51;
const OCI_SFC_ALTER_SESSION =               52;
const OCI_SFC_ALTER_USER =                  53;
const OCI_SFC_COMMIT_WORK =                 54;
const OCI_SFC_ROLLBACK =                    55;
const OCI_SFC_SAVEPOINT =                   56;
const OCI_SFC_CREATE_CONTROL_FILE =         57;
const OCI_SFC_ALTER_TRACING =               58;
const OCI_SFC_CREATE_TRIGGER =              59;
const OCI_SFC_ALTER_TRIGGER =               60;
const OCI_SFC_DROP_TRIGGER =                61;
const OCI_SFC_ANALYZE_TABLE =               62;
const OCI_SFC_ANALYZE_INDEX =               63;
const OCI_SFC_ANALYZE_CLUSTER =             64;
const OCI_SFC_CREATE_PROFILE =              65;
const OCI_SFC_DROP_PROFILE =                66;
const OCI_SFC_ALTER_PROFILE =               67;
const OCI_SFC_DROP_PROCEDURE =              68;

const OCI_SFC_ALTER_RESOURCE_COST =         70;
const OCI_SFC_CREATE_SNAPSHOT_LOG =         71;
const OCI_SFC_ALTER_SNAPSHOT_LOG =          72;
const OCI_SFC_DROP_SNAPSHOT_LOG =           73;
const OCI_SFC_CREATE_SNAPSHOT =             74;
const OCI_SFC_ALTER_SNAPSHOT =              75;
const OCI_SFC_DROP_SNAPSHOT =               76;
const OCI_SFC_CREATE_TYPE =                 77;
const OCI_SFC_DROP_TYPE =                   78;
const OCI_SFC_ALTER_ROLE =                  79;
const OCI_SFC_ALTER_TYPE =                  80;
const OCI_SFC_CREATE_TYPE_BODY =            81;
const OCI_SFC_ALTER_TYPE_BODY =             82;
const OCI_SFC_DROP_TYPE_BODY =              83;
const OCI_SFC_DROP_LIBRARY =                84;
const OCI_SFC_TRUNCATE_TABLE =              85;
const OCI_SFC_TRUNCATE_CLUSTER =            86;
const OCI_SFC_CREATE_BITMAPFILE =           87;
const OCI_SFC_ALTER_VIEW =                  88;
const OCI_SFC_DROP_BITMAPFILE =             89;
const OCI_SFC_SET_CONSTRAINTS =             90;
const OCI_SFC_CREATE_FUNCTION =             91;
const OCI_SFC_ALTER_FUNCTION =              92;
const OCI_SFC_DROP_FUNCTION =               93;
const OCI_SFC_CREATE_PACKAGE =              94;
const OCI_SFC_ALTER_PACKAGE =               95;
const OCI_SFC_DROP_PACKAGE =                96;
const OCI_SFC_CREATE_PACKAGE_BODY =         97;
const OCI_SFC_ALTER_PACKAGE_BODY =          98;
const OCI_SFC_DROP_PACKAGE_BODY =           99;
const OCI_SFC_CREATE_DIRECTORY =            157;
const OCI_SFC_DROP_DIRECTORY =              158;
const OCI_SFC_CREATE_LIBRARY =              159;
const OCI_SFC_CREATE_JAVA =                 160;
const OCI_SFC_ALTER_JAVA =                  161;
const OCI_SFC_DROP_JAVA =                   162;
const OCI_SFC_CREATE_OPERATOR =             163;
const OCI_SFC_CREATE_INDEXTYPE =            164;
const OCI_SFC_DROP_INDEXTYPE =              165;
const OCI_SFC_ALTER_INDEXTYPE =             166;
const OCI_SFC_DROP_OPERATOR =               167;
const OCI_SFC_ASSOCIATE_STATISTICS =        168;
const OCI_SFC_DISASSOCIATE_STATISTICS =     169;
const OCI_SFC_CALL_METHOD =                 170;
const OCI_SFC_CREATE_SUMMARY =              171;
const OCI_SFC_ALTER_SUMMARY =               172;
const OCI_SFC_DROP_SUMMARY =                173;
const OCI_SFC_CREATE_DIMENSION =            174;
const OCI_SFC_ALTER_DIMENSION =             175;
const OCI_SFC_DROP_DIMENSION =              176;
const OCI_SFC_CREATE_CONTEXT =              177;
const OCI_SFC_DROP_CONTEXT =                178;
const OCI_SFC_ALTER_OUTLINE =               179;
const OCI_SFC_CREATE_OUTLINE =              180;
const OCI_SFC_DROP_OUTLINE =                181;
const OCI_SFC_UPDATE_INDEXES =              182;
const OCI_SFC_ALTER_OPERATOR =              183;

/* size constants */

const OCI_SIZE_FORMAT =                     64;
const OCI_SIZE_BUFFER =                     512;
const OCI_SIZE_LONG =                       (64*1024)-1;
const OCI_SIZE_DATE =                       45;
const OCI_SIZE_TIMESTAMP =                  54;
const OCI_SIZE_FORMAT_TODATE =              14;
const OCI_SIZE_NULL =                       4;
const OCI_SIZE_PRECISION =                  10;
const OCI_SIZE_ROWID =                      23;
const OCI_SIZE_DIRECTORY =                  30;
const OCI_SIZE_FILENAME =                   255;
const OCI_SIZE_FORMAT_NUMS =                40;
const OCI_SIZE_FORMAT_NUML =                65;
const OCI_SIZE_OBJ_NAME =                   30;

const OCI_HASH_DEFAULT_SIZE =               256;
...
const OCI_STRING_DEFAULT_PREC =             3;
...
extern(System) boolean OCI_Initialize
(
...
extern(System) boolean OCI_Cleanup
(
...
extern(System) uint OCI_GetOCICompileVersion
(
...
extern(System) uint OCI_GetOCIRuntimeVersion
(
...
extern(System) uint OCI_GetImportMode
(
...
extern(System) uint OCI_GetCharsetMetaData
(
...
extern(System) uint OCI_GetCharsetUserData
(
...
extern(System) void OCI_EnableWarnings
(
    boolean value
);
...
extern(System) void OCI_SetErrorHandler
(
    POCI_ERROR handler
);
...
extern(System) boolean OCI_SetHAHandler
(
...
extern(System) OCI_Error * OCI_GetLastError
(
...
extern(System) const(mtext)* OCI_ErrorGetString
(
    OCI_Error *err
);
...
extern(System) uint OCI_ErrorGetType
(
    OCI_Error *err
);
...
extern(System) int OCI_ErrorGetOCICode
(
    OCI_Error *err
);
...
extern(System) int OCI_ErrorGetInternalCode
(
    OCI_Error *err
);
...
extern(System) OCI_Connection * OCI_ErrorGetConnection
(
    OCI_Error *err
);
...
extern(System) OCI_Statement * OCI_ErrorGetStatement
(
    OCI_Error *err
);
...
extern(System) uint OCI_ErrorGetRow
(
    OCI_Error *err
);
...
extern(System) OCI_Connection* OCI_ConnectionCreate
(
    const(mtext)* db,
    const(mtext)* user,
    const(mtext)* pwd,
...
extern(System) boolean OCI_ConnectionFree
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_IsConnected
(
    OCI_Connection *con
);
...
extern(System) void * OCI_GetUserData
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetUserData
(
    OCI_Connection *con,
    void           *data
);
...
extern(System) boolean OCI_SetSessionTag
(
    OCI_Connection *con,
    const(mtext)*   tag
);
...
extern(System) const(mtext)* OCI_GetSessionTag
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetDatabase
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetUserName
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetPassword
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetPassword
(
    OCI_Connection *con,
...
extern(System) boolean OCI_SetUserPassword
(
    const(mtext)* db,
    const(mtext)* user,
    const(mtext)* pwd,
...
extern(System) uint OCI_GetSessionMode
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetVersionServer
(
    OCI_Connection *con
);
...
extern(System) uint OCI_GetServerMajorVersion
(
    OCI_Connection *con
);
...
extern(System) uint OCI_GetServerMinorVersion
(
    OCI_Connection *con
);
...
extern(System) uint OCI_GetServerRevisionVersion
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetDefaultFormatDate
(
    OCI_Connection *con,
    const(mtext)*   format
);
...
extern(System) const(mtext)* OCI_GetDefaultFormatDate
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetDefaultFormatNumeric
(
    OCI_Connection* con,
    const(mtext)*   format
);
...
extern(System) const(mtext)* OCI_GetDefaultFormatNumeric
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetTransaction
(
    OCI_Connection  *con,
...
extern(System) uint OCI_GetVersionConnection
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetTrace
(
    OCI_Connection* con,
    uint trace,
    const(mtext)* value
...
extern(System) const(mtext)* OCI_GetTrace
(
    OCI_Connection *con,
    uint    trace
);
...
extern(System) boolean OCI_Ping
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetDBName
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetInstanceName
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetServiceName
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetServerName
(
    OCI_Connection *con
);
...
extern(System) const(mtext)* OCI_GetDomainName
(
    OCI_Connection *con
);
...
extern(System) OCI_Timestamp * OCI_GetInstanceStartTime
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_IsTAFCapable
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetTAFHandler
(
    OCI_Connection   *con,
...
extern(System) uint OCI_GetStatementCacheSize
(
    OCI_Connection  *con
);
...
extern(System) boolean OCI_SetStatementCacheSize
(
    OCI_Connection  *con,
    uint     value
);
...
extern(System) OCI_Pool * OCI_PoolCreate
(
    const(mtext)* db,
    const(mtext)* user,
    const(mtext)* pwd,
...
extern(System) boolean OCI_PoolFree
(
    OCI_Pool *pool
);
...
extern(System) OCI_Connection * OCI_PoolGetConnection
(
    OCI_Pool *pool,
    mtext    *tag
);
...
extern(System) uint OCI_PoolGetTimeout
(
    OCI_Pool *pool
);
...
extern(System) boolean OCI_PoolSetTimeout
(
    OCI_Pool    *pool,
    uint value
);
...
extern(System) boolean OCI_PoolGetNoWait
(
    OCI_Pool *pool
);
...
extern(System) boolean OCI_PoolSetNoWait
(
    OCI_Pool *pool,
    boolean   value
);
...
extern(System) uint OCI_PoolGetBusyCount
(
    OCI_Pool *pool
);
...
extern(System) uint OCI_PoolGetOpenedCount
(
    OCI_Pool *pool
);
...
extern(System) uint OCI_PoolGetMin
(
    OCI_Pool *pool
);
...
extern(System) uint OCI_PoolGetMax
(
    OCI_Pool *pool
);
...
extern(System) uint OCI_PoolGetIncrement
(
    OCI_Pool *pool
);
...
extern(System) uint OCI_PoolGetStatementCacheSize
(
    OCI_Pool *pool
);
...
extern(System) boolean OCI_PoolSetStatementCacheSize
(
    OCI_Pool     *pool,
    uint  value
);
...
extern(System) boolean OCI_Commit
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_Rollback
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_SetAutoCommit
(
    OCI_Connection *con,
    boolean         enable
);
...
extern(System) boolean OCI_GetAutoCommit
(
    OCI_Connection *con
);
...
extern(System) OCI_Transaction * OCI_TransactionCreate
(
    OCI_Connection *con,
    uint    timeout,
    uint    mode,
...
extern(System) boolean OCI_TransactionFree
(
    OCI_Transaction *trans
);
...
extern(System) boolean OCI_TransactionStart
(
    OCI_Transaction *trans
);
...
extern(System) boolean OCI_TransactionStop
(
    OCI_Transaction *trans
);
...
extern(System) boolean OCI_TransactionResume
(
    OCI_Transaction *trans
);
...
extern(System) boolean OCI_TransactionPrepare
(
    OCI_Transaction *trans
);
...
extern(System) boolean OCI_TransactionForget
(
    OCI_Transaction *trans
);
...
extern(System) uint OCI_TransactionGetMode
(
    OCI_Transaction *trans
);
...
extern(System) uint OCI_TransactionGetTimeout
(
    OCI_Transaction *trans
);
...
extern(System) OCI_Statement * OCI_StatementCreate
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_StatementFree
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_Prepare
(
    OCI_Statement *stmt,
    const(mtext)*  sql
);
...
extern(System) boolean OCI_Execute
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_ExecuteStmt
(
    OCI_Statement *stmt,
    const(mtext)*  sql
);
...
extern(System) boolean OCI_Parse
(
    OCI_Statement* stmt,
    const(mtext)*  sql
);
...
extern(System) boolean OCI_Describe
(
    OCI_Statement* stmt,
    const(mtext)*  sql
);
...
extern(System) const(mtext)* OCI_GetSql
(
    OCI_Statement *stmt
);
...
extern(System) uint OCI_GetSqlErrorPos
(
    OCI_Statement *stmt
);
...
extern(System) uint OCI_GetAffectedRows
(
    OCI_Statement *stmt
);
...
extern(System) uint OCI_GetSQLCommand
(
    OCI_Statement *stmt
);
...
extern(System) const(mtext)* OCI_GetSQLVerb
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_BindArraySetSize
(
    OCI_Statement *stmt,
    uint   size
);
...
extern(System) uint OCI_BindArrayGetSize
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_AllowRebinding
(
    OCI_Statement *stmt,
    boolean        value
);
...
extern(System) boolean OCI_BindShort
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    short*         data
...
extern(System) boolean OCI_BindArrayOfShorts
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    short*         data,
...
extern(System) boolean OCI_BindUnsignedShort
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    ushort*        data
...
extern(System) boolean OCI_BindArrayOfUnsignedShorts
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    ushort*        data,
...
extern(System) boolean OCI_BindInt
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    int*           data
...
extern(System) boolean OCI_BindArrayOfInts
(
    OCI_Statement* stmt,
    const(mtext)*  name,
    int*           data,
...
extern(System) boolean OCI_BindUnsignedInt
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint  *data
...
extern(System) boolean OCI_BindArrayOfUnsignedInts
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint  *data,
...
extern(System) boolean OCI_BindBigInt
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    big_int       *data
...
extern(System) boolean OCI_BindArrayOfBigInts
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    big_int       *data,
...
extern(System) boolean OCI_BindUnsignedBigInt
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    big_uint      *data
...
extern(System) boolean OCI_BindArrayOfUnsignedBigInts
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    big_uint      *data,
...
extern(System) boolean OCI_BindString
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    dtext         *data,
...
extern(System) boolean OCI_BindArrayOfStrings
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    dtext         *data,
...
extern(System) boolean OCI_BindRaw
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    void          *data,
...
extern(System) boolean OCI_BindArrayOfRaws
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    void          *data,
...
extern(System) boolean OCI_BindDouble
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    double        *data
...
extern(System) boolean OCI_BindArrayOfDoubles
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    double        *data,
...
extern(System) boolean OCI_BindDate
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Date      *data
...
extern(System) boolean OCI_BindArrayOfDates
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Date     **data,
...
extern(System) boolean OCI_BindTimestamp
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Timestamp *data
...
extern(System) boolean OCI_BindArrayOfTimestamps
(
    OCI_Statement  *stmt,
    const(mtext)*   name,
    OCI_Timestamp **data,
...
extern(System) boolean OCI_BindInterval
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Interval  *data
...
extern(System) boolean OCI_BindArrayOfIntervals
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Interval **data,
...
extern(System) boolean OCI_BindLob
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Lob       *data
...
extern(System) boolean OCI_BindArrayOfLobs
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Lob      **data,
...
extern(System) boolean OCI_BindFile
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_File      *data
...
extern(System) boolean OCI_BindArrayOfFiles
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_File     **data,
...
extern(System) boolean OCI_BindObject
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Object    *data
...
extern(System) boolean OCI_BindArrayOfObjects
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Object   **data,
...
extern(System) boolean OCI_BindColl
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Coll      *data
...
extern(System) boolean OCI_BindArrayOfColls
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Coll     **data,
...
extern(System) boolean OCI_BindRef
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Ref       *data
...
extern(System) boolean OCI_BindArrayOfRefs
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Ref      **data,
...
extern(System) boolean OCI_BindStatement
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Statement *data
...
extern(System) boolean OCI_BindLong
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_Long      *data,
...
extern(System) OCI_Error * OCI_GetBatchError
(
    OCI_Statement *stmt
);
...
extern(System) uint OCI_GetBatchErrorCount
(
    OCI_Statement *stmt
);
...
extern(System) uint OCI_GetBindCount
(
    OCI_Statement *stmt
);
...
extern(System) OCI_Bind * OCI_GetBind
(
    OCI_Statement *stmt,
    uint   index
);
...
extern(System) OCI_Bind * OCI_GetBind2
(
    OCI_Statement *stmt,
    const(mtext)*  name
);
...
extern(System) const(mtext)* OCI_BindGetName
(
    OCI_Bind *bnd
);
...
extern(System) boolean OCI_BindSetDirection
(
    OCI_Bind    *bnd,
    uint direction
);
...
extern(System) uint OCI_BindGetDirection
(
    OCI_Bind *bnd
);
...
extern(System) uint OCI_BindGetType
(
    OCI_Bind *bnd
);
...
extern(System) uint OCI_BindGetSubtype
(
    OCI_Bind *bnd
);
...
extern(System) uint OCI_BindGetDataCount
(
    OCI_Bind *bnd
);
...
extern(System) void * OCI_BindGetData
(
    OCI_Bind *bnd
);
...
extern(System) OCI_Statement * OCI_BindGetStatement
(
    OCI_Bind *bnd
);
...
extern(System) boolean OCI_BindSetDataSize
(
    OCI_Bind    *bnd,
    uint size
);
...
extern(System) boolean OCI_BindSetDataSizeAtPos
(
    OCI_Bind    *bnd,
    uint position,
    uint size
...
extern(System) uint OCI_BindGetDataSize
(
    OCI_Bind *bnd
);
...
extern(System) uint OCI_BindGetDataSizeAtPos
(
    OCI_Bind    *bnd,
    uint position
);
...
extern(System) boolean OCI_BindSetNull
(
    OCI_Bind *bnd
);
...
extern(System) boolean OCI_BindSetNullAtPos
(
    OCI_Bind    *bnd,
    uint position
);
...
extern(System) boolean OCI_BindIsNull
(
    OCI_Bind *bnd
);
...
extern(System) boolean OCI_BindIsNullAtPos
(
    OCI_Bind    *bnd,
    uint position
);
...
extern(System) boolean OCI_BindSetCharsetForm
(
    OCI_Bind    *bnd,
    uint csfrm
);
...
extern(System) OCI_Resultset * OCI_GetResultset
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_ReleaseResultsets
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_FetchNext
(
    OCI_Resultset *rs
);
...
extern(System) boolean OCI_FetchPrev
(
    OCI_Resultset *rs
);
...
extern(System) boolean OCI_FetchFirst
(
    OCI_Resultset *rs
);
...
extern(System) boolean OCI_FetchLast
(
    OCI_Resultset *rs
);
...
extern(System) boolean OCI_FetchSeek
(
    OCI_Resultset *rs,
    uint   mode,
    int            offset
...
extern(System) uint OCI_GetRowCount
(
    OCI_Resultset *rs
);
...
extern(System) uint OCI_GetCurrentRow
(
    OCI_Resultset *rs
);
...
extern(System) uint OCI_GetColumnCount
(
    OCI_Resultset *rs
);
...
extern(System) OCI_Column * OCI_GetColumn
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Column * OCI_GetColumn2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) uint OCI_GetColumnIndex
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) const(mtext)* OCI_ColumnGetName
(
    OCI_Column *col
);
...
extern(System) uint OCI_ColumnGetType
(
    OCI_Column *col
);
...
extern(System) uint OCI_ColumnGetCharsetForm
(
    OCI_Column *col
);
...
extern(System) const(mtext)* OCI_ColumnGetSQLType
(
    OCI_Column *col
);
...
extern(System) uint OCI_ColumnGetFullSQLType
(
    OCI_Column  *col,
    mtext       *buffer,
    uint len
...
extern(System) uint OCI_ColumnGetSize
(
    OCI_Column *col
);
...
extern(System) int OCI_ColumnGetScale
(
    OCI_Column *col
);
...
extern(System) int OCI_ColumnGetPrecision
(
    OCI_Column *col
);
...
extern(System) int OCI_ColumnGetFractionalPrecision
(
    OCI_Column *col
);
...
extern(System) int OCI_ColumnGetLeadingPrecision
(
    OCI_Column *col
);
...
extern(System) boolean OCI_ColumnGetNullable
(
    OCI_Column *col
);
...
extern(System) boolean OCI_ColumnGetCharUsed
(
    OCI_Column *col
);
...
extern(System) OCI_TypeInfo * OCI_ColumnGetTypeInfo
(
    OCI_Column *col
);
...
extern(System) uint OCI_ColumnGetSubType
(
    OCI_Column *col
);
...
extern(System) boolean OCI_SetStructNumericType
(
    OCI_Resultset *rs,
    uint   index,
    uint   type
...
extern(System) boolean OCI_SetStructNumericType2
(
    OCI_Resultset *rs,
    const(mtext)*  name,
    uint   type
...
extern(System) boolean OCI_GetStruct
(
    OCI_Resultset *rs,
    void          *row_struct,
    void          *row_struct_ind
...
extern(System) short OCI_GetShort
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) short OCI_GetShort2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) ushort OCI_GetUnsignedShort
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) ushort OCI_GetUnsignedShort2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) uint OCI_GetUnsignedInt
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) uint OCI_GetUnsignedInt2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) big_int OCI_GetBigInt
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) big_int OCI_GetBigInt2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) big_uint OCI_GetUnsignedBigInt
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) big_uint OCI_GetUnsignedBigInt2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) const(dtext)* OCI_GetString
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) const(dtext)* OCI_GetString2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) uint OCI_GetRaw2
(
    OCI_Resultset *rs,
    const(mtext)*  name,
    void          *buffer,
...
extern(System) double OCI_GetDouble
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) double OCI_GetDouble2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Date * OCI_GetDate
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Date * OCI_GetDate2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Timestamp * OCI_GetTimestamp
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Timestamp * OCI_GetTimestamp2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Interval * OCI_GetInterval
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Interval * OCI_GetInterval2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Statement * OCI_GetStatement
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Statement * OCI_GetStatement2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Lob * OCI_GetLob
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Lob * OCI_GetLob2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_File * OCI_GetFile
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_File * OCI_GetFile2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Object * OCI_GetObject
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Object * OCI_GetObject2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Coll * OCI_GetColl
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Coll * OCI_GetColl2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Ref * OCI_GetRef
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Ref * OCI_GetRef2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Long * OCI_GetLong
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) OCI_Long * OCI_GetLong2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) boolean OCI_IsNull
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) boolean OCI_IsNull2
(
    OCI_Resultset *rs,
    const(mtext)* name
);
...
extern(System) OCI_Statement * OCI_ResultsetGetStatement
(
    OCI_Resultset *rs
);
...
extern(System) uint OCI_GetDataLength
(
    OCI_Resultset *rs,
    uint   index
);
...
extern(System) boolean OCI_ServerEnableOutput
(
    OCI_Connection *con,
    uint    bufsize,
    uint    arrsize,
...
extern(System) boolean OCI_ServerDisableOutput
(
    OCI_Connection *con
);
...
extern(System) const(dtext)* OCI_ServerGetOutput
(
    OCI_Connection *con
);
...
extern(System) OCI_Coll * OCI_CollCreate
(
    OCI_TypeInfo *typinf
);
...
extern(System) boolean OCI_CollFree
(
    OCI_Coll *coll
);
...
extern(System) OCI_Coll ** OCI_CollArrayCreate
(
    OCI_Connection *con,
    OCI_TypeInfo   *typinf,
    uint    nbelem
...
extern(System) boolean OCI_CollArrayFree
(
    OCI_Coll **colls
);
...
extern(System) boolean OCI_CollAssign
(
    OCI_Coll *coll,
    OCI_Coll *coll_src
);
...
extern(System) OCI_TypeInfo * OCI_CollGetTypeInfo
(
    OCI_Coll *coll
);
...
extern(System) uint OCI_CollGetType
(
    OCI_Coll *coll
);
...
extern(System) uint OCI_CollGetMax
(
    OCI_Coll *coll
);
...
extern(System) uint OCI_CollGetSize
(
    OCI_Coll *coll
);
...
extern(System) boolean OCI_CollTrim
(
    OCI_Coll    *coll,
    uint nb_elem
);
...
extern(System) boolean OCI_CollClear
(
    OCI_Coll *coll
);
...
extern(System) OCI_Elem * OCI_CollGetAt
(
    OCI_Coll    *coll,
    uint index
);
...
extern(System) boolean OCI_CollGetAt2
(
    OCI_Coll    *coll,
    uint index,
    OCI_Elem    *elem
...
extern(System) boolean OCI_CollSetAt
(
    OCI_Coll    *coll,
    uint index,
    OCI_Elem    *elem
...
extern(System) boolean OCI_CollAppend
(
    OCI_Coll *coll,
    OCI_Elem *elem
);
...
extern(System) OCI_Iter * OCI_IterCreate
(
    OCI_Coll *coll
);
...
extern(System) boolean OCI_IterFree
(
    OCI_Iter *iter
);
...
extern(System) OCI_Elem * OCI_IterGetNext
(
    OCI_Iter *iter
);
...
extern(System) OCI_Elem * OCI_IterGetPrev
(
    OCI_Iter *iter
);
...
extern(System) OCI_Elem * OCI_ElemCreate
(
    OCI_TypeInfo *typinf
);
...
extern(System) boolean OCI_ElemFree
(
    OCI_Elem *elem
);
...
extern(System) short OCI_ElemGetShort
(
    OCI_Elem *elem
);
...
extern(System) ushort OCI_ElemGetUnsignedShort
(
    OCI_Elem *elem
);
...
extern(System) int OCI_ElemGetInt
(
    OCI_Elem *elem
);
...
extern(System) uint OCI_ElemGetUnsignedInt
(
    OCI_Elem *elem
);
...
extern(System) big_int OCI_ElemGetBigInt
(
    OCI_Elem *elem
);
...
extern(System) big_uint OCI_ElemGetUnsignedBigInt
(
    OCI_Elem *elem
);
...
extern(System) double OCI_ElemGetDouble
(
    OCI_Elem *elem
);
...
extern(System) const(dtext)* OCI_ElemGetString
(
    OCI_Elem *elem
);
...
extern(System) uint  OCI_ElemGetRaw
(
    OCI_Elem    *elem,
    void        *value,
    uint len
...
extern(System) OCI_Date * OCI_ElemGetDate
(
    OCI_Elem *elem
);
...
extern(System) OCI_Timestamp * OCI_ElemGetTimestamp
(
    OCI_Elem *elem
);
...
extern(System) OCI_Interval * OCI_ElemGetInterval
(
    OCI_Elem *elem
);
...
extern(System) OCI_Lob *  OCI_ElemGetLob
(
    OCI_Elem *elem
);
...
extern(System) OCI_File *  OCI_ElemGetFile
(
    OCI_Elem *elem
);
...
extern(System) OCI_Object * OCI_ElemGetObject
(
    OCI_Elem *elem
);
...
extern(System) OCI_Coll * OCI_ElemGetColl
(
    OCI_Elem *elem
);
...
extern(System) OCI_Ref * OCI_ElemGetRef
(
    OCI_Elem *elem
);
...
extern(System) boolean OCI_ElemSetShort
(
    OCI_Elem *elem,
    short     value
);
...
extern(System) boolean OCI_ElemSetUnsignedShort
(
    OCI_Elem      *elem,
    ushort value
);
...
extern(System) boolean OCI_ElemSetInt
(
    OCI_Elem *elem,
    int       value
);
...
extern(System) boolean OCI_ElemSetUnsignedInt
(
    OCI_Elem    *elem,
    uint value
);
...
extern(System) boolean OCI_ElemSetBigInt
(
    OCI_Elem *elem,
    big_int   value
);
...
extern(System) boolean OCI_ElemSetUnsignedBigInt
(
    OCI_Elem *elem,
    big_uint  value
);
...
extern(System) boolean OCI_ElemSetDouble
(
    OCI_Elem *elem,
    double    value
);
...
extern(System) boolean OCI_ElemSetString
(
    OCI_Elem    *elem,
    const(dtext)*value
);
...
extern(System) boolean OCI_ElemSetRaw
(
    OCI_Elem    *elem,
    void        *value,
    uint len
...
extern(System) boolean OCI_ElemSetDate
(
    OCI_Elem *elem,
    OCI_Date *value
);
...
extern(System) boolean OCI_ElemSetTimestamp
(
    OCI_Elem      *elem,
    OCI_Timestamp *value
);
...
extern(System) boolean OCI_ElemSetInterval
(
    OCI_Elem     *elem,
    OCI_Interval *value
);
...
extern(System) boolean OCI_ElemSetColl
(
    OCI_Elem *elem,
    OCI_Coll *value
);
...
extern(System) boolean OCI_ElemSetObject
(
    OCI_Elem   *elem,
    OCI_Object *value
);
...
extern(System) boolean OCI_ElemSetLob
(
    OCI_Elem *elem,
    OCI_Lob  *value
);
...
extern(System) boolean OCI_ElemSetFile
(
    OCI_Elem *elem,
    OCI_File *value
);
...
extern(System) boolean OCI_ElemSetRef
(
    OCI_Elem *elem,
    OCI_Ref  *value
);
...
extern(System) boolean OCI_ElemIsNull
(
    OCI_Elem *elem
);
...
extern(System) boolean OCI_ElemSetNull
(
    OCI_Elem *elem
);
...
extern(System) OCI_Resultset * OCI_GetNextResultset
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_RegisterShort
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterUnsignedShort
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterInt
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterUnsignedInt
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterBigInt
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterUnsignedBigInt
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterString
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   len
...
extern(System) boolean OCI_RegisterRaw
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   len
...
extern(System) boolean OCI_RegisterDouble
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterDate
(
    OCI_Statement *stmt,
    const(mtext)* name
);
...
extern(System) boolean OCI_RegisterTimestamp
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   type
...
extern(System) boolean OCI_RegisterInterval
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   type
...
extern(System) boolean OCI_RegisterObject
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_TypeInfo  *typinf
...
extern(System) boolean OCI_RegisterLob
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   type
...
extern(System) boolean OCI_RegisterFile
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    uint   type
...
extern(System) boolean OCI_RegisterRef
(
    OCI_Statement *stmt,
    const(mtext)*  name,
    OCI_TypeInfo  *typinf
...
extern(System) uint OCI_GetStatementType
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetFetchMode
(
    OCI_Statement *stmt,
    uint   mode
);
...
extern(System) uint OCI_GetFetchMode
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetBindMode
(
    OCI_Statement *stmt,
    uint   mode
);
...
extern(System) uint OCI_GetBindMode
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetBindAllocation
(
    OCI_Statement *stmt,
    uint   mode
);
 ...
 *
 */
extern(System) uint OCI_GetBindAllocation
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetFetchSize
(
    OCI_Statement *stmt,
    uint   size
);
...
extern(System) uint OCI_GetFetchSize
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetPrefetchSize
(
    OCI_Statement *stmt,
    uint   size
);
...
extern(System) uint OCI_GetPrefetchSize
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetPrefetchMemory
(
    OCI_Statement *stmt,
    uint   size
);
...
extern(System) uint OCI_GetPrefetchMemory
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetLongMaxSize
(
    OCI_Statement *stmt,
    uint   size
);
...
extern(System) uint OCI_GetLongMaxSize
(
    OCI_Statement *stmt
);
...
extern(System) boolean OCI_SetLongMode
(
    OCI_Statement *stmt,
    uint   mode
);
...
extern(System) uint OCI_GetLongMode
(
    OCI_Statement *stmt
);
...
extern(System) OCI_Connection * OCI_StatementGetConnection
(
    OCI_Statement *stmt
);
...
extern(System) OCI_Lob * OCI_LobCreate
(
    OCI_Connection *con,
    uint    type
);
...
extern(System) boolean OCI_LobFree
(
    OCI_Lob *lob
);
...
extern(System) OCI_Lob ** OCI_LobArrayCreate
(
    OCI_Connection *con,
    uint    type,
    uint    nbelem
...
extern(System) boolean OCI_LobArrayFree
(
    OCI_Lob **lobs
);
...
extern(System) uint OCI_LobGetType
(
    OCI_Lob *lob
);
...
extern(System) boolean OCI_LobSeek
(
    OCI_Lob     *lob,
    big_uint     offset,
    uint mode
...
extern(System) big_uint OCI_LobGetOffset
(
    OCI_Lob *lob
);
...
extern(System) uint OCI_LobRead
(
    OCI_Lob     *lob,
    void        *buffer,
    uint len
...
extern(System) boolean OCI_LobRead2
(
    OCI_Lob      *lob,
    void         *buffer,
    uint *char_count,
...
extern(System) uint OCI_LobWrite
(
    OCI_Lob     *lob,
    void        *buffer,
    uint len
...
extern(System) boolean OCI_LobWrite2
(
    OCI_Lob      *lob,
    void         *buffer,
    uint *char_count,
...
extern(System) boolean OCI_LobTruncate
(
    OCI_Lob *lob,
    big_uint size
);
...
extern(System) big_uint OCI_LobGetLength
(
    OCI_Lob *lob
);
...
extern(System) uint OCI_LobGetChunkSize
(
    OCI_Lob *lob
);
...
extern(System) big_uint OCI_LobErase
(
    OCI_Lob *lob,
    big_uint offset,
    big_uint len
...
extern(System) uint OCI_LobAppend
(
    OCI_Lob     *lob,
    void        *buffer,
    uint len
...
extern(System) boolean OCI_LobAppend2
(
    OCI_Lob      *lob,
    void         *buffer,
    uint *char_count,
...
extern(System) boolean OCI_LobAppendLob
(
    OCI_Lob *lob,
    OCI_Lob *lob_src
);
...
extern(System) boolean OCI_LobIsTemporary
(
    OCI_Lob *lob
);
...
extern(System) boolean OCI_LobCopy
(
    OCI_Lob *lob,
    OCI_Lob *lob_src,
    big_uint offset_dst,
...
extern(System) boolean OCI_LobCopyFromFile
(
    OCI_Lob  *lob,
    OCI_File *file,
    big_uint  offset_dst,
...
extern(System) boolean OCI_LobOpen
(
    OCI_Lob     *lob,
    uint mode
);
...
extern(System) boolean OCI_LobClose
(
    OCI_Lob *lob
);
...
extern(System) boolean OCI_LobIsEqual
(
    OCI_Lob *lob,
    OCI_Lob *lob2
);
...
extern(System) boolean OCI_LobAssign
(
    OCI_Lob *lob,
    OCI_Lob *lob_src
);
...
extern(System) big_uint OCI_LobGetMaxSize
(
    OCI_Lob *lob
);
...
extern(System) boolean OCI_LobFlush
(
    OCI_Lob *lob
);
...
extern(System) boolean OCI_LobEnableBuffering
(
    OCI_Lob *lob,
    boolean  value
);
...
extern(System) OCI_File * OCI_FileCreate
(
    OCI_Connection *con,
    uint    type
);
...
extern(System) boolean OCI_FileFree
(
    OCI_File *file
);
...
extern(System) OCI_File ** OCI_FileArrayCreate
(
    OCI_Connection *con,
    uint    type,
    uint    nbelem
...
extern(System) boolean OCI_FileArrayFree
(
    OCI_File **files
);
...
extern(System) uint OCI_FileGetType
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileSeek
(
    OCI_File    *file,
    big_uint     offset,
    uint mode
...
extern(System) big_uint OCI_FileGetOffset
(
    OCI_File *file
);
...
extern(System) uint OCI_FileRead
(
    OCI_File    *file,
    void        *buffer,
    uint len
...
extern(System) big_uint OCI_FileGetSize
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileExists
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileSetName
(
    OCI_File    * file,
    const(mtext)* dir,
    const(mtext)* name
...
extern(System) const(mtext)* OCI_FileGetDirectory
(
    OCI_File *file
);
...
extern(System) const(mtext)* OCI_FileGetName
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileOpen
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileIsOpen
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileClose
(
    OCI_File *file
);
...
extern(System) boolean OCI_FileIsEqual
(
    OCI_File *file,
    OCI_File *file2
);
...
extern(System) boolean OCI_FileAssign
(
    OCI_File *file,
    OCI_File *file_src
);
...
extern(System) OCI_Long * OCI_LongCreate
(
    OCI_Statement *stmt,
    uint   type
);
...
extern(System) boolean OCI_LongFree
(
    OCI_Long *lg
);
...
extern(System) uint OCI_LongGetType
(
    OCI_Long *lg
);
...
extern(System) uint OCI_LongRead
(
    OCI_Long    *lg,
    void        *buffer,
    uint len
...
extern(System) uint OCI_LongWrite
(
    OCI_Long    *lg,
    void        *buffer,
    uint len
...
extern(System) uint OCI_LongGetSize
(
    OCI_Long *lg
);
...
extern(System) void * OCI_LongGetBuffer
(
    OCI_Long *lg
);
...
extern(System) OCI_Date * OCI_DateCreate
(
    OCI_Connection *con
);
...
extern(System) boolean OCI_DateFree
(
    OCI_Date *date
);
...
extern(System) OCI_Date ** OCI_DateArrayCreate
(
    OCI_Connection *con,
    uint    nbelem
);
...
extern(System) boolean OCI_DateArrayFree
(
    OCI_Date **dates
);
...
extern(System) boolean OCI_DateAddDays
(
    OCI_Date *date,
    int       nb
);
...
extern(System) boolean OCI_DateAddMonths
(
    OCI_Date *date,
    int       nb
);
...
extern(System) int OCI_DateAssign
(
    OCI_Date *date,
    OCI_Date *date_src
);
...
extern(System) int OCI_DateCheck
(
    OCI_Date *date
);
...
extern(System) int OCI_DateCompare
(
    OCI_Date *date,
    OCI_Date *date2
);
...
extern(System) int OCI_DateDaysBetween
(
    OCI_Date *date,
    OCI_Date *date2
);
...
extern(System) boolean OCI_DateFromText
(
    OCI_Date    *date,
    const(mtext)*str,
    const(mtext)*fmt
...
extern(System) boolean OCI_DateToText
(
    OCI_Date    *date,
    const(mtext)*fmt,
    int          size,
...
extern(System) boolean OCI_DateGetDate
(
    OCI_Date *date,
    int      *year,
    int      *month,
...
extern(System) boolean OCI_DateGetTime
(
    OCI_Date *date,
    int      *hour,
    int      *min,
...
extern(System) boolean OCI_DateGetDateTime
(
    OCI_Date *date,
    int      *year,
    int      *month,
...
extern(System) boolean OCI_DateSetDate
(
    OCI_Date *date,
    int       year,
    int       month,
...
extern(System) boolean OCI_DateSetTime
(
    OCI_Date *date,
    int       hour,
    int       min,
...
extern(System) boolean OCI_DateSetDateTime
(
    OCI_Date *date,
    int       year,
    int       month,
...
extern(System) boolean OCI_DateLastDay
(
    OCI_Date *date
);
...
extern(System) boolean OCI_DateNextDay
(
    OCI_Date    *date,
    const(mtext)*day
);
...
extern(System) boolean OCI_DateSysDate
(
    OCI_Date *date
);
...
extern(System) boolean OCI_DateZoneToZone
(
    OCI_Date    *date,
    const(mtext)*zone1,
    const(mtext)*zone2
...
extern(System) boolean OCI_DateFromCTime
(
    OCI_Date  *date,
    tm *ptm,
    time_t     t
...
extern(System) OCI_Timestamp * OCI_TimestampCreate
(
    OCI_Connection *con,
    uint    type
);
...
extern(System) boolean OCI_TimestampFree
(
    OCI_Timestamp *tmsp
);
...
extern(System) OCI_Timestamp ** OCI_TimestampArrayCreate
(
    OCI_Connection *con,
    uint    type,
    uint    nbelem
...
extern(System) boolean OCI_TimestampArrayFree
(
    OCI_Timestamp **tmsps
);
...
extern(System) uint OCI_TimestampGetType
(
    OCI_Timestamp *tmsp
);
...
extern(System) boolean OCI_TimestampAssign
(
    OCI_Timestamp *tmsp,
...
extern(System) int OCI_TimestampCheck
(
    OCI_Timestamp *tmsp
);
...
extern(System) int OCI_TimestampCompare
(
    OCI_Timestamp *tmsp,
    OCI_Timestamp *tmsp2
);
...
extern(System) boolean OCI_TimestampConstruct
(
    OCI_Timestamp *tmsp,
    int            year,
    int            month,
...
extern(System) boolean OCI_TimestampConvert
(
    OCI_Timestamp *tmsp,
    OCI_Timestamp *tmsp_src
);
...
extern(System) boolean OCI_TimestampFromText
(
    OCI_Timestamp* tmsp,
    const(mtext)*  str,
    const(mtext)*  fmt
...
extern(System) boolean OCI_TimestampToText
(
    OCI_Timestamp* tmsp,
    const(mtext)*  fmt,
    int            size,
...
extern(System) boolean OCI_TimestampGetDate
(
    OCI_Timestamp *tmsp,
    int           *year,
    int           *month,
...
extern(System) boolean OCI_TimestampGetTime
(
    OCI_Timestamp *tmsp,
    int           *hour,
    int           *min,
...
extern(System) boolean OCI_TimestampGetDateTime
(
    OCI_Timestamp *tmsp,
    int           *year,
    int           *month,
...
extern(System) boolean OCI_TimestampGetTimeZoneName
(
    OCI_Timestamp *tmsp,
    int            size,
    mtext         *str
...
extern(System) boolean OCI_TimestampGetTimeZoneOffset
(
    OCI_Timestamp *tmsp,
    int           *hour,
    int           *min
...
extern(System) boolean OCI_TimestampIntervalAdd
(
    OCI_Timestamp *tmsp,
    OCI_Interval  *itv
);
...
extern(System) boolean OCI_TimestampIntervalSub
(
    OCI_Timestamp *tmsp,
    OCI_Interval  *itv
);
...
extern(System) boolean OCI_TimestampSubtract
(
    OCI_Timestamp *tmsp,
    OCI_Timestamp *tmsp2,
    OCI_Interval  *itv
...
extern(System) boolean OCI_TimestampSysTimestamp
(
    OCI_Timestamp *tmsp
);
...
extern(System) boolean OCI_TimestampToCTime
(
    OCI_Timestamp *tmsp,
    tm     *ptm,
    time_t        *pt
...
extern(System) boolean OCI_TimestampFromCTime
(
    OCI_Timestamp *tmsp,
    tm     *ptm,
    time_t         t
...
extern(System) OCI_Interval * OCI_IntervalCreate
(
    OCI_Connection *con,
    uint    type
);
...
extern(System) boolean OCI_IntervalFree
(
    OCI_Interval *itv
);
...
extern(System) OCI_Interval ** OCI_IntervalArrayCreate
(
    OCI_Connection *con,
    uint    type,
    uint    nbelem
...
extern(System) boolean OCI_IntervalArrayFree
(
    OCI_Interval **itvs
);
...
extern(System) uint OCI_IntervalGetType
(
    OCI_Interval *itv
);
...
extern(System) boolean OCI_IntervalAssign
(
    OCI_Interval *itv,
...
extern(System) int OCI_IntervalCheck
(
    OCI_Interval *itv
);
...
extern(System) int OCI_IntervalCompare
(
    OCI_Interval *itv,
    OCI_Interval *itv2
);
...
extern(System) boolean OCI_IntervalFromText
(
    OCI_Interval *itv,
    const(mtext)*str
);
...
extern(System) boolean OCI_IntervalToText
(
    OCI_Interval *itv,
    int           leading_prec,
    int           fraction_prec,
...
extern(System) boolean OCI_IntervalFromTimeZone
(
    OCI_Interval *itv,
    const(mtext)*str
);
...
extern(System) boolean OCI_IntervalGetDaySecond
(
    OCI_Interval *itv,
    int          *day,
    int          *hour,
...
extern(System) boolean OCI_IntervalGetYearMonth
(
    OCI_Interval *itv,
    int          *year,
    int          *month
...
extern(System) boolean OCI_IntervalSetDaySecond
(
    OCI_Interval *itv,
    int           day,
    int           hour,
...
extern(System) boolean OCI_IntervalSetYearMonth
(
    OCI_Interval *itv,
    int           year,
    int           month
...
extern(System) boolean OCI_IntervalAdd
(
    OCI_Interval *itv,
    OCI_Interval *itv2
);
...
extern(System) boolean OCI_IntervalSubtract
(
    OCI_Interval *itv,
    OCI_Interval *itv2
);
...
extern(System) OCI_Object * OCI_ObjectCreate
(
    OCI_Connection *con,
    OCI_TypeInfo   *typinf
);
...
extern(System) boolean OCI_ObjectFree
(
    OCI_Object *obj
);
...
extern(System) OCI_Object ** OCI_ObjectArrayCreate
(
    OCI_Connection *con,
    OCI_TypeInfo   *typinf,
    uint    nbelem
...
extern(System) boolean OCI_ObjectArrayFree
(
    OCI_Object **objs
);
...
extern(System) boolean OCI_ObjectAssign
(
    OCI_Object *obj,
    OCI_Object *obj_src
);
...
extern(System) uint OCI_ObjectGetType
(
    OCI_Object *obj
);
...
extern(System) boolean OCI_ObjectGetSelfRef
(
    OCI_Object *obj,
    OCI_Ref    *rf
);
...
extern(System) OCI_TypeInfo * OCI_ObjectGetTypeInfo
(
    OCI_Object *obj
);
...
extern(System) short OCI_ObjectGetShort
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) ushort OCI_ObjectGetUnsignedShort
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) int OCI_ObjectGetInt
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) uint OCI_ObjectGetUnsignedInt
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) big_int OCI_ObjectGetBigInt
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) big_uint OCI_ObjectGetUnsignedBigInt
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) double OCI_ObjectGetDouble
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) const(dtext)* OCI_ObjectGetString
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) int OCI_ObjectGetRaw
(
    OCI_Object  *obj,
    const(mtext)*attr,
    void        *value,
...
extern(System) OCI_Date * OCI_ObjectGetDate
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Timestamp * OCI_ObjectGetTimestamp
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Interval * OCI_ObjectGetInterval
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Coll * OCI_ObjectGetColl
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Ref * OCI_ObjectGetRef
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Object * OCI_ObjectGetObject
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_Lob * OCI_ObjectGetLob
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) OCI_File * OCI_ObjectGetFile
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) boolean OCI_ObjectSetShort
(
    OCI_Object  *obj,
    const(mtext)*attr,
    short        value
...
extern(System) boolean OCI_ObjectSetUnsignedShort
(
    OCI_Object    *obj,
    const(mtext)*attr,
    ushort value
...
extern(System) boolean OCI_ObjectSetInt
(
    OCI_Object  *obj,
    const(mtext)*attr,
    int          value
...
extern(System) boolean OCI_ObjectSetUnsignedInt
(
    OCI_Object  *obj,
    const(mtext)*attr,
    uint value
...
extern(System) boolean OCI_ObjectSetBigInt
(
    OCI_Object  *obj,
    const(mtext)*attr,
    big_int      value
...
extern(System) boolean OCI_ObjectSetUnsignedBigInt
(
    OCI_Object  *obj,
    const(mtext)*attr,
    big_uint     value
...
extern(System) boolean OCI_ObjectSetDouble
(
    OCI_Object  *obj,
    const(mtext)*attr,
    double       value
...
extern(System) boolean OCI_ObjectSetString
(
    OCI_Object  *obj,
    const(mtext)*attr,
    const(dtext)*value
...
extern(System) boolean OCI_ObjectSetRaw
(
    OCI_Object  *obj,
    const(mtext)*attr,
    void        *value,
...
extern(System) boolean OCI_ObjectSetDate
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_Date    *value
...
extern(System) boolean OCI_ObjectSetTimestamp
(
    OCI_Object    *obj,
    const(mtext)*attr,
    OCI_Timestamp *value
...
extern(System) boolean OCI_ObjectSetInterval
(
    OCI_Object   *obj,
    const(mtext)*attr,
    OCI_Interval *value
...
extern(System) boolean OCI_ObjectSetColl
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_Coll    *value
...
extern(System) boolean OCI_ObjectSetObject
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_Object  *value
...
extern(System) boolean OCI_ObjectSetLob
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_Lob     *value
...
extern(System) boolean OCI_ObjectSetFile
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_File    *value
...
extern(System) boolean OCI_ObjectSetRef
(
    OCI_Object  *obj,
    const(mtext)*attr,
    OCI_Ref     *value
...
extern(System) boolean OCI_ObjectIsNull
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) boolean OCI_ObjectSetNull
(
    OCI_Object  *obj,
    const(mtext)*attr
);
...
extern(System) boolean OCI_ObjectGetStruct
(
    OCI_Object *obj,
    void      **pp_struct,
    void      **pp_ind
...
extern(System) OCI_Ref * OCI_RefCreate
(
    OCI_Connection *con,
    OCI_TypeInfo   *typinf
);
...
extern(System) boolean OCI_RefFree
(
    OCI_Ref *rf
);
...
extern(System) OCI_Ref ** OCI_RefArrayCreate
(
    OCI_Connection *con,
    OCI_TypeInfo   *typinf,
    uint    nbelem
...
extern(System) boolean OCI_RefArrayFree
(
    OCI_Ref **refs
);
...
extern(System) boolean OCI_RefAssign
(
    OCI_Ref *rf,
    OCI_Ref *ref_src
);
...
extern(System) OCI_TypeInfo * OCI_RefGetTypeInfo
(
    OCI_Ref *rf
);
...
extern(System) OCI_Object * OCI_RefGetObject
(
    OCI_Ref *rf
);
...
extern(System) boolean OCI_RefIsNull
(
    OCI_Ref *rf
);
...
extern(System) boolean OCI_RefSetNull
(
    OCI_Ref *rf
);
...
extern(System) uint OCI_RefGetHexSize
(
    OCI_Ref *rf
);
...
extern(System) boolean OCI_RefToText
(
    OCI_Ref     *rf,
    uint size,
    mtext       *str
...
extern(System) boolean OCI_Break
(
    OCI_Connection *con
);
...
extern(System) OCI_TypeInfo * OCI_TypeInfoGet
(
    OCI_Connection *con,
    const(mtext)* name,
    uint    type
...
extern(System) uint OCI_TypeInfoGetType
(
    OCI_TypeInfo *typinf
);
...
extern(System) boolean OCI_TypeInfoFree
(
    OCI_TypeInfo *typinf
);
...
extern(System) uint OCI_TypeInfoGetColumnCount
(
    OCI_TypeInfo *typinf
);
...
extern(System) OCI_Column * OCI_TypeInfoGetColumn
(
    OCI_TypeInfo *typinf,
    uint  index
);
...
extern(System) const(mtext)* OCI_TypeInfoGetName
(
    OCI_TypeInfo *typinf
);
...
extern(C) boolean OCI_Immediate
(
    OCI_Connection *con,
    const(mtext)*sql,
    ...
...
extern(C) boolean OCI_ImmediateFmt
(
    OCI_Connection *con,
    const(mtext)*sql,
    ...
...
extern(C) boolean OCI_PrepareFmt
(
    OCI_Statement *stmt,
    const(mtext)*sql,
    ...
...
extern(C) boolean OCI_ExecuteStmtFmt
(
    OCI_Statement *stmt,
    const(mtext)*sql,
    ...
...
extern(C) boolean OCI_DescribeFmt
(
    OCI_Statement *stmt,
    const(mtext)*sql,
    ...
...
extern(System) OCI_HashTable * OCI_HashCreate
(
    uint size,
    uint type
);
...
extern(System) boolean OCI_HashFree
(
    OCI_HashTable *table
);
...
extern(System) uint OCI_HashGetSize
(
    OCI_HashTable *table
);
...
extern(System) uint OCI_HashGetType
(
    OCI_HashTable *table
);
...
extern(System) boolean OCI_HashAddString
(
    OCI_HashTable* table,
    const(mtext)*  key,
    const(mtext)*  value
...
extern(System) const(mtext)* OCI_HashGetString
(
    OCI_HashTable* table,
    const(mtext)*  key
);
...
extern(System) boolean OCI_HashAddInt
(
    OCI_HashTable *table,
    const(mtext)*key,
    int            value
...
extern(System) int OCI_HashGetInt
(
    OCI_HashTable *table,
    const(mtext)*key
);
...
extern(System) boolean OCI_HashAddPointer
(
    OCI_HashTable* table,
    const(mtext)*  key,
    void*          value
...
extern(System) void * OCI_HashGetPointer
(
    OCI_HashTable *table,
    const(mtext)*key
);
...
extern(System) OCI_HashEntry * OCI_HashLookup
(
    OCI_HashTable *table,
    const(mtext)*key,
    boolean        create
...
extern(System) OCI_HashValue * OCI_HashGetValue
(
    OCI_HashTable *table,
    const(mtext)*key
);
...
extern(System) OCI_HashEntry * OCI_HashGetEntry
(
    OCI_HashTable *table,
    uint   index
);
...
extern(System) OCI_Mutex * OCI_MutexCreate
(
...
extern(System) boolean OCI_MutexFree
(
    OCI_Mutex *mutex
);
...
extern(System) boolean OCI_MutexAcquire
(
    OCI_Mutex *mutex
);
...
extern(System) boolean OCI_MutexRelease
(
    OCI_Mutex *mutex
);
...
extern(System) OCI_Thread * OCI_ThreadCreate
(
...
extern(System) boolean OCI_ThreadFree
(
    OCI_Thread *thread
);
...
extern(System) boolean OCI_ThreadRun
(
    OCI_Thread *thread,
    POCI_THREAD proc,
    void       *arg
...
extern(System) boolean OCI_ThreadJoin
(
    OCI_Thread *thread
);
...
extern(System) boolean OCI_ThreadKeyCreate
(
    const(mtext)*      name,
...
extern(System) boolean OCI_ThreadKeySetValue
(
    const(mtext)* name,
    void        *value
);
...
extern(System) void * OCI_ThreadKeyGetValue
(
    const(mtext)* name
);
...
extern(System) OCI_DirPath * OCI_DirPathCreate
(
    OCI_TypeInfo *typinf,
 ...
 *
 */
extern(System) boolean OCI_DirPathFree
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathSetColumn
(
    OCI_DirPath *dp,
    uint index,
    const(mtext)* name,
...
extern(System) boolean OCI_DirPathPrepare
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathSetEntry
(
    OCI_DirPath *dp,
    uint row,
    uint index,
...
extern(System) uint OCI_DirPathConvert
(
    OCI_DirPath *dp
);
...
extern(System) uint OCI_DirPathLoad
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathReset
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathFinish
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathAbort
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathSave
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathFlushRow
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathSetCurrentRows
(
    OCI_DirPath *dp,
    uint nb_rows
);
...
extern(System) uint OCI_DirPathGetCurrentRows
(
    OCI_DirPath *dp
);
...
extern(System) uint OCI_DirPathGetMaxRows
(
    OCI_DirPath *dp
);
...
extern(System) boolean OCI_DirPathSetDateFormat
(
    OCI_DirPath *dp,
    const(mtext)*format
);
...
extern(System) boolean OCI_DirPathSetParallel
(
    OCI_DirPath *dp,
    boolean      value
);
...
extern(System) boolean OCI_DirPathSetNoLog
(
    OCI_DirPath *dp,
    boolean      value
);
...
extern(System) boolean OCI_DirPathSetCacheSize
(
    OCI_DirPath *dp,
    uint size
);
...
extern(System) boolean OCI_DirPathSetBufferSize
(
    OCI_DirPath *dp,
    uint size
);
...
extern(System) uint OCI_DirPathGetRowCount
(
    OCI_DirPath *dp
);
...
extern(System) uint OCI_DirPathGetAffectedRows
(
    OCI_DirPath *dp
);
...
extern(System) uint OCI_DirPathGetErrorColumn
(
    OCI_DirPath *dp
);
...
extern(System) uint OCI_DirPathGetErrorRow
(
    OCI_DirPath *dp
);
...
extern(System) OCI_Msg * OCI_MsgCreate
(
    OCI_TypeInfo *typinf
);
...
extern(System) boolean OCI_MsgFree
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgReset
(
    OCI_Msg *msg
);
...
extern(System) OCI_Object * OCI_MsgGetObject
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetObject
(
    OCI_Msg    *msg,
    OCI_Object *obj
);
...
extern(System) boolean OCI_MsgGetRaw
(
    OCI_Msg      *msg,
    void         *raw,
    uint *size
...
extern(System) boolean OCI_MsgSetRaw
(
    OCI_Msg      *msg,
    const void   *raw,
    uint  size
...
extern(System) int OCI_MsgGetAttemptCount
(
    OCI_Msg *msg
);
...
extern(System) int OCI_MsgGetEnqueueDelay
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetEnqueueDelay
(
    OCI_Msg *msg,
    int      value
);
...
extern(System) OCI_Date * OCI_MsgGetEnqueueTime
(
    OCI_Msg *msg
);
...
extern(System) int OCI_MsgGetExpiration
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetExpiration
(
    OCI_Msg *msg,
    int      value
);
...
extern(System) uint OCI_MsgGetState
(
    OCI_Msg *msg
);
...
extern(System) int OCI_MsgGetPriority
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetPriority
(
    OCI_Msg *msg,
    int      value
);
...
extern(System) boolean OCI_MsgGetID
(
    OCI_Msg      *msg,
    void         *id,
    uint *len
...
extern(System) boolean OCI_MsgGetOriginalID
(
    OCI_Msg      *msg,
    void         *id,
    uint *len
...
extern(System) boolean OCI_MsgSetOriginalID
(
    OCI_Msg      *msg,
    const(void)*  id,
    uint  len
...
extern(System) OCI_Agent * OCI_MsgGetSender
(
    OCI_Msg   *msg
);
...
extern(System) boolean OCI_MsgSetSender
(
    OCI_Msg   *msg,
    OCI_Agent *sender
);
...
extern(System) boolean OCI_MsgSetConsumers
(
    OCI_Msg     *msg,
    OCI_Agent  **consumers,
    uint count
...
extern(System) const(mtext)* OCI_MsgGetCorrelation
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetCorrelation
(
    OCI_Msg     *msg,
 ...
 *
 */
extern(System) const(mtext)* OCI_MsgGetExceptionQueue
(
    OCI_Msg *msg
);
...
extern(System) boolean OCI_MsgSetExceptionQueue
(
    OCI_Msg     *msg,
    const(mtext)*queue
);
...
extern(System) OCI_Enqueue * OCI_EnqueueCreate
(
    OCI_TypeInfo *typinf,
    const(mtext)* name
);
...
extern(System) boolean OCI_EnqueueFree
(
    OCI_Enqueue *enqueue
);
...
extern(System) boolean OCI_EnqueuePut
(
    OCI_Enqueue *enqueue,
    OCI_Msg     *msg
);
...
extern(System) boolean OCI_EnqueueSetSequenceDeviation
(
    OCI_Enqueue *enqueue,
    uint sequence
);
...
extern(System) uint OCI_EnqueueGetSequenceDeviation
(
    OCI_Enqueue *enqueue
);
...
extern(System) boolean OCI_EnqueueSetVisibility
(
    OCI_Enqueue *enqueue,
    uint visibility
);
...
extern(System) uint OCI_EnqueueGetVisibility
(
    OCI_Enqueue *enqueue
);
...
extern(System) boolean OCI_EnqueueSetRelativeMsgID
(
    OCI_Enqueue  *enqueue,
    const(void)*  id,
    uint  len
...
extern(System) boolean OCI_EnqueueGetRelativeMsgID
(
    OCI_Enqueue *enqueue,
    void         *id,
    uint *len
...
extern(System) OCI_Dequeue * OCI_DequeueCreate
(
    OCI_TypeInfo *typinf,
    const(mtext)* name
);
...
extern(System) boolean OCI_DequeueFree
(
    OCI_Dequeue *dequeue
);
...
extern(System) OCI_Msg * OCI_DequeueGet
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetConsumer
(
    OCI_Dequeue *dequeue,
...
extern(System) const(mtext)* OCI_DequeueGetConsumer
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetCorrelation
(
    OCI_Dequeue *dequeue,
    const(mtext)*pattern
);
...
extern(System) const(mtext)* OCI_DequeueGetCorrelation
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetRelativeMsgID
(
    OCI_Dequeue  *dequeue,
    const(void)*  id,
    uint  len
...
extern(System) boolean OCI_DequeueGetRelativeMsgID
(
    OCI_Dequeue  *dequeue,
    void         *id,
    uint *len
...
extern(System) boolean OCI_DequeueSetVisibility
(
    OCI_Dequeue *dequeue,
    uint visibility
);
...
extern(System) uint OCI_DequeueGetVisibility
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetMode
(
    OCI_Dequeue *dequeue,
    uint mode
);
...
extern(System) uint OCI_DequeueGetMode
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetNavigation
(
    OCI_Dequeue *dequeue,
    uint position
);
...
extern(System) uint OCI_DequeueGetNavigation
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetWaitTime
(
    OCI_Dequeue *dequeue,
    int          timeout
);
...
extern(System) int OCI_DequeueGetWaitTime
(
    OCI_Dequeue *dequeue
);
...
extern(System) boolean OCI_DequeueSetAgentList
(
    OCI_Dequeue *dequeue,
    OCI_Agent  **consumers,
    uint count
...
extern(System) OCI_Agent * OCI_DequeueListen
(
    OCI_Dequeue *dequeue,
    int          timeout
);
...
extern(System) OCI_Agent * OCI_AgentCreate
(
    OCI_Connection *con,
    const(mtext)* name,
    const(mtext)*address
...
extern(System) boolean OCI_AgentFree
(
    OCI_Agent *agent
);
...
extern(System) boolean OCI_AgentSetName
(
    OCI_Agent   *agent,
    const(mtext)* name
);
...
extern(System) const(mtext)* OCI_AgentGetName
(
    OCI_Agent *agent
);
...
extern(System) boolean OCI_AgentSetAddress
(
    OCI_Agent   *agent,
    const(mtext)*address
);
...
extern(System) const(mtext)* OCI_AgentGetAddress
(
    OCI_Agent *agent
);
...
extern(System) boolean OCI_QueueCreate
(
    OCI_Connection *con,
...
extern(System) boolean OCI_QueueAlter
(
    OCI_Connection *con,
    const(mtext)*queue_name,
    uint    max_retries,
...
extern(System) boolean OCI_QueueDrop
(
    OCI_Connection *con,
    const(mtext)*queue_name
);
...
extern(System) boolean OCI_QueueStart
(
    OCI_Connection *con,
    const(mtext)*queue_name,
    boolean         enqueue,
...
extern(System) boolean OCI_QueueStop
(
    OCI_Connection *con,
    const(mtext)*queue_name,
    boolean         enqueue,
...
extern(System) boolean OCI_QueueTableCreate
(
    OCI_Connection* con,
    const(mtext)*   queue_table,
    ...
    uint            message_grouping,
    const(mtext)*   comment,
    uint            primary_instance,
    uint            secondary_instance,
...
extern(System) boolean OCI_QueueTableAlter
(
    OCI_Connection* con,
    const(mtext)*   queue_table,
    const(mtext)*   comment,
...
extern(System) boolean OCI_QueueTableDrop
(
    OCI_Connection* con,
    const(mtext)*   queue_table,
    boolean         force
...
extern(System) boolean OCI_QueueTablePurge
(
    OCI_Connection* con,
    const(mtext)*   queue_table,
...
extern(System) boolean OCI_QueueTableMigrate
(
    OCI_Connection* con,
    const(mtext)*   queue_table,
    const(mtext)*   compatible
...
extern(System) OCI_Subscription * OCI_SubscriptionRegister
(
    OCI_Connection* con,
    const(mtext)*   name,
    uint            type,
...
extern(System) boolean OCI_SubscriptionUnregister
(
...
extern(System) boolean OCI_SubscriptionAddStatement
(
    OCI_Subscription *sub,
    OCI_Statement    *stmt
);
...
extern(System) const(mtext)* OCI_SubscriptionGetName
(
    OCI_Subscription *sub
);
...
extern(System) uint OCI_SubscriptionGetPort
(
    OCI_Subscription *sub
);
...
extern(System) uint OCI_SubscriptionGetTimeout
(
    OCI_Subscription *sub
);
...
extern(System) uint OCI_EventGetType
(
    OCI_Event *event
);
...
extern(System) uint OCI_EventGetOperation
(
    OCI_Event *event
);
...
extern(System) const(dtext)* OCI_EventGetDatabase
(
    OCI_Event *event
);
...
extern(System) const(dtext)* OCI_EventGetObject
(
    OCI_Event *event
);
...
extern(System) const(dtext)* OCI_EventGetRowid
(
    OCI_Event *event
);
...
extern(System) OCI_Subscription * OCI_EventGetSubscription
(
    OCI_Event *event
);
...
extern(System) boolean OCI_DatabaseStartup
(
    const(mtext)* db,
    const(mtext)* user,
    const(mtext)* pwd,
...
extern(System) boolean OCI_DatabaseShutdown
(
    const(mtext)* db,
    const(mtext)* user,
    const(mtext)* pwd,
...
extern(System) const(void)* OCI_HandleGetEnvironment
(
...
extern(System) const(void)* OCI_HandleGetContext
(
    OCI_Connection *con
);
...
extern(System) const(void)* OCI_HandleGetServer
(
    OCI_Connection *con
);
...
extern(System) const(void)* OCI_HandleGetError
(
    OCI_Connection *con
);
...
extern(System) const(void)* OCI_HandleGetSession
(
    OCI_Connection *con
);
...
extern(System) const(void)* OCI_HandleGetTransaction
(
    OCI_Transaction *trans
);
...
extern(System) const(void)* OCI_HandleGetStatement
(
    OCI_Statement *stmt
);
...
extern(System) const(void)* OCI_HandleGetLob
(
    OCI_Lob *lob
);
...
extern(System) const(void)* OCI_HandleGetFile
(
    OCI_File *file
);
...
extern(System) const(void)* OCI_HandleGetDate
(
    OCI_Date *date
);
...
extern(System) const(void)* OCI_HandleGetTimestamp
(
    OCI_Timestamp *tmsp
);
...
extern(System) const(void)* OCI_HandleGetInterval
(
    OCI_Interval *itv
);
...
extern(System) const(void)* OCI_HandleGetObject
(
    OCI_Object *obj
);
...
extern(System) const(void)* OCI_HandleGetColl
(
    OCI_Coll *coll
);
...
extern(System) const(void)* OCI_HandleGetRef
(
    OCI_Ref *rf
);
...
extern(System) const(void)* OCI_HandleGetMutex
(
    OCI_Mutex *mutex
);
...
extern(System) const(void)* OCI_HandleGetThreadID
(
    OCI_Thread *thread
);
...
extern(System) const(void)* OCI_HandleGetThread
(
    OCI_Thread *thread
);
...
extern(System) const(void)* OCI_HandleGetDirPathCtx
(
    OCI_DirPath *dp
);
...
extern(System) const(void)* OCI_HandleGetDirPathColArray
(
    OCI_DirPath *dp
);
...
extern(System) const(void)* OCI_HandleGetDirPathStream
(
    OCI_DirPath *dp
);
...
extern(System) const(void)* OCI_HandleGetSubscription
(
    OCI_Subscription *sub
);
...
const OCI_ERR_API =                         OCI_ERR_ORACLE;

/* macros added in version 3.2.0 */

const OCI_ERR_NOT_SUPPORTED =               OCI_ERR_DATATYPE_NOT_SUPPORTED;
const OCI_SCHEMA_TABLE =                    OCI_TIF_TABLE;
const OCI_SCHEMA_VIEW =                     OCI_TIF_VIEW;
const OCI_SCHEMA_TYPE =                     OCI_TIF_TYPE;
...
const OCI_8 =  OCI_8_1;
const OCI_9 =  OCI_9_0;
const OCI_10 = OCI_10_1;
const OCI_11 = OCI_11_1;

/* macro added in version 3.6.0 */

const OCI_CHAR_UNICODE =  OCI_CHAR_WIDE;
const OCI_CSF_CHARSET =   OCI_CSF_DEFAULT;
